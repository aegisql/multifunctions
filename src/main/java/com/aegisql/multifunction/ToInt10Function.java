...
/**
 * The interface To int 10 function.
 *
 ...
 */
@FunctionalInterface
public interface ToInt10Function<A1,A2,A3,A4,A5,A6,A7,A8,A9,A10> {
    /**
     * Apply as int int.
     *
     * @param a1  the a 1
     ...
     * @return the int
     */
    int applyAsInt(A1 a1,A2 a2,A3 a3,A4 a4,A5 a5,A6 a6,A7 a7,A8 a8,A9 a9,A10 a10);
