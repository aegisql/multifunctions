...
class Methods3Test {
    ...
    public void functionsTest() {
        FunctionMethods3 fm = new FunctionMethods3();
        assertEquals("FM3:A1",fm.f1(new A1()));
        assertEquals("FM3:A1A2",fm.f2(new A1(),new A2()));
        assertEquals("FM3:A1A2A3",fm.f3(new A1(),new A2(),new A3()));
        assertEquals("FM3:A1A2A3A4",fm.f4(new A1(),new A2(),new A3(),new A4()));
        assertEquals("FM3:A1A2A3A4A5",fm.f5(new A1(),new A2(),new A3(),new A4(),new A5()));
        assertEquals("FM3:A1A2A3A4A5A6",fm.f6(new A1(),new A2(),new A3(),new A4(),new A5(),new A6()));
        assertEquals("FM3:A1A2A3A4A5A6A7",fm.f7(new A1(),new A2(),new A3(),new A4(),new A5(),new A6(),new A7()));
        assertEquals("FM3:A1A2A3A4A5A6A7A8",fm.f8(new A1(),new A2(),new A3(),new A4(),new A5(),new A6(),new A7(),new A8()));
        assertEquals("FM3:C1A2A3A4A5A6A7A8A9",fm.f9(new C1(),new A2(),new A3(),new A4(),new A5(),new A6(),new A7(),new A8(),new A9()));
        assertEquals("FM3:D1A2A3A4A5A6A7A8A9A10",fm.f10(new D1(),new A2(),new A3(),new A4(),new A5(),new A6(),new A7(),new A8(),new A9(),new A10()));
    }

    @Test
    public void functionsETest() throws IsNull, IsMandatory {
        FunctionMethods3 fm = new FunctionMethods3();
        assertEquals("FM3:A1",fm.f1E(new A1()));
        assertEquals("FM3:A1A2",fm.f2E(new A1(),new A2()));
        assertEquals("FM3:A1A2A3",fm.f3E(new A1(),new A2(),new A3()));
        assertEquals("FM3:A1A2A3A4",fm.f4E(new A1(),new A2(),new A3(),new A4()));
        assertEquals("FM3:A1A2A3A4A5",fm.f5E(new A1(),new A2(),new A3(),new A4(),new A5()));
        assertEquals("FM3:A1A2A3A4A5A6",fm.f6E(new A1(),new A2(),new A3(),new A4(),new A5(),new A6()));
        assertEquals("FM3:A1A2A3A4A5A6A7",fm.f7E(new A1(),new A2(),new A3(),new A4(),new A5(),new A6(),new A7()));
        assertEquals("FM3:A1A2A3A4A5A6A7A8",fm.f8E(new A1(),new A2(),new A3(),new A4(),new A5(),new A6(),new A7(),new A8()));
        assertEquals("FM3:C1A2A3A4A5A6A7A8A9",fm.f9E(new C1(),new A2(),new A3(),new A4(),new A5(),new A6(),new A7(),new A8(),new A9()));
        assertEquals("FM3:D1A2A3A4A5A6A7A8A9A10",fm.f10E(new D1(),new A2(),new A3(),new A4(),new A5(),new A6(),new A7(),new A8(),new A9(),new A10()));
